        ...
        <div class="mx-auto rounded-lg p-8 bg-indigo-100">
            <form method="POST" action="/books/{{$book->id}}">
                ...
                <div class="py-5 flex justify-between">
                    ...
                    <input type="text" name="name" id="name" class="rounded" placeholder="{{$book->name}}">
                </div>
                @error('name')
               ...
               <div class="py-5 flex justify-between">
                ...
                <input type="number" min="0" name="quantity" class="rounded" id="quantity" placeholder="{{$book->quantity}}">
            </div>
            @error('quantity')
                    <div class="text-red-900 text-xs">
                        {{$message}}
            ...
            @enderror
               <div class="py-5 flex justify-between">
                ...
                <input type="text" name="description" id="description" class="rounded" placeholder="{{$book->description}}">
            </div>
              @error('description')
                        <div class="text-red-900 text-xs">
                            {{$message}}
